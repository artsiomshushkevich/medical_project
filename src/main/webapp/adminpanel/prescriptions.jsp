...
<div id="wrapper">
    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a class="active-menu" href="prescriptions-index.action"><i class="fa fa-desktop"></i>Prescriptions</a>
                </li>
                <li>
    ...
    <%@include file='prescriptions-modal-add.jsp'%>
    <%@include file='prescriptions-modal-edit.jsp'%>
    <%@include file='prescriptions-modal-delete.jsp'%>
    <!-- /. NAV SIDE  -->
    <div id="page-wrapper">
        <div id="page-inner">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="container">
                                <button class="btn btn-primary" onclick="showAddModal()">Add new prescription</button>
                            </div>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                    <s:iterator value="prescriptionsList" var="prescription">
                                        <tr>
...
<script>
    ...
    {
        $('.prescriptions_add_modal').modal();
    }

    function showEditModal(instance)
    {
        var id = $(instance).attr('id_instance');
        $('#prescriptions_edit_id').val(id);
        $('.prescriptions_edit_modal').modal();
    }

    function showDeleteModal(instance)
    {
        var id = $(instance).attr('id_instance');
        $('#prescriptions_delete_id').val(id);
        $('.prescriptions_delete_modal').modal();
    }
</script>
</body>
