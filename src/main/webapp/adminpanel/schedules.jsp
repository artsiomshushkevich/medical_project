...
<div id="wrapper">
    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a class="active-menu" href="schedules-index.action"><i class="fa fa-desktop"></i>Schedules</a>
                </li>
                <li>
    ...
    <%@include file='schedules-modal-add.jsp'%>
    <%@include file='schedules-modal-edit.jsp'%>
    <%@include file='schedules-modal-delete.jsp'%>
    <!-- /. NAV SIDE  -->
    <div id="page-wrapper">
        <div id="page-inner">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="container">
                                <button class="btn btn-primary" onclick="showAddModal()">Add new schedule</button>
                            </div>
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <s:iterator value="schedulesList" var="schedule">
                                        <tr>
                                            ...
                                            <td><s:property value="weekDay"></s:property></td>
                                            <td><s:property value="beginWorkday"></s:property></td>
                                            <td><s:property value="endWorkday"></s:property></td>
                                            <td><s:property value="duration"></s:property></td>
                                            <td><s:property value="cabinet"></s:property></td>
                                            <td>
...
<script>
    ...
    {
        var id = $(instance).attr('id_instance');
        $('#schedules_delete_id').val(id);
        $('.schedules_delete_modal').modal();
    }
</script>
</body>
