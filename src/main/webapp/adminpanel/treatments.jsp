...
<div id="wrapper">
    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a class="active-menu" href="treatments-index.action"><i class="fa fa-desktop"></i>Treatments</a>
                </li>
                <li>
    ...
    <%@include file='treatments-modal-add.jsp'%>
    <%@include file='treatments-modal-edit.jsp'%>
    <%@include file='treatments-modal-delete.jsp'%>
    <!-- /. NAV SIDE  -->
    <div id="page-wrapper">
        <div id="page-inner">
            <div class="row">
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <s:iterator value="treatmentsList" var="treatment">
                                        <tr>
                                            ...
                                            <td><s:property value="type_treatment"></s:property></td>
                                            <td><s:property value="method"></s:property></td>
                                            <td><s:property value="treatment"></s:property></td>
                                            <td>
...
<script>
    ...
    {
        var id = $(instance).attr('id_instance');
        $('#treatments_delete_id').val(id);
        $('.treatments_delete_modal').modal();
    }
</script>
</body>
