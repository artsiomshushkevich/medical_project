                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <s:iterator value="ordersList" var="order">
                                        <tr>
                                            ...
                                            <td><s:property value="departmentAddress"></s:property></td>
                                            <td><s:property value="doctorSpeciality"></s:property></td>
                                            <td><s:property value="doctorFullname"></s:property></td>
                                            <td>
                                                <button class="btn btn-link" id_instance="<s:property value="id"/>" onclick="showEditModal(this)">get order in pdf</button>
                                            </td>
                                        </tr>
                                    </s:iterator>
                                    </tbody>
